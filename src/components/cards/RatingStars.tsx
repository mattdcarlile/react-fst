      ...
      <div className='flex items-center z-2'>
        ...
        {ratings > 0 ? (
          ...
          stars.map((_, i) => {
            ...
            return (
              <div key={i} style={{ position: "relative", width: 20, height: 20 }}>
                <svg width='20' height='20' viewBox="0 0 20 20" fill='#d1d5dc'>
                  <path d="M10 15l-5.878 3.09 1.122-6.545L.488 6.91l6.564-.955L10 0l2.948 5.955 6.564.955-4.756 4.635 1.122 6.545z" />
                </svg>

                {fill > 0 && (
                  <div className="absolute top-0 left-0 overflow-hidden h-full" style={{width: `${fill * 100}%`}}>
                    <svg width='20' height='20' viewBox="0 0 20 20" fill='#a6192e'>
                      <path d="M10 15l-5.878 3.09 1.122-6.545L.488 6.91l6.564-.955L10 0l2.948 5.955 6.564.955-4.756 4.635 1.122 6.545z" />
                    </svg>
                  </div>
                )}
          ...
          <div>
            ...
            <a href="https://healthcare.utah.edu/patient-family-services/experience/surveys" target="_blank" className='underline hover:no-underline text-gray-500'>(Learn About Our Rating System)</a>
          </div>
        )}
      </div>
    </>
