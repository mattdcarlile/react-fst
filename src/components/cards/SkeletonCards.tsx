    ...
    <>
      <div className='fst-docs grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8'>
        ...
        {Array.from({ length: 4 }, (_, i) => (
          <div key={i} className="fst-cards animate-pulse">
                ...
                <div className="flex">
                  {Array.from({ length: 5 }, (_, i) => (
                    <svg key={i} className='w-5 h-5 text-gray-300' viewBox="0 0 20 20"
                      fill="currentColor">
                      <path fill="currentColor" stroke="currentColor" strokeWidth={1.5} d="M10 15l-5.878 3.09 1.122-6.545L.488 6.91l6.564-.955L10 0l2.948 5.955 6.564.955-4.756 4.635 1.122 6.545z"/>
                    </svg>
                  ))}
                </div>
              </div>
